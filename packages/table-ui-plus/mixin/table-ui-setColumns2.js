...
import TableUIActionView from '../../../iview-fast-local/table-ui-actionView.vue';
import TableUITopicContent from '../../../iview-fast-local/table-ui-topicContent.vue';
...
import VTableUIAction from '../../../iview-fast-local/v_table-ui-action.vue'
                    ...
                    if (item.UI && item.UI.type) {
                        ...
                        item.render = function (h, params) {
                            ...
                            switch (item.UI.type) {
                                ...
                                //viewPageAds3 页面专用组件，渲染action参数，实现跳转
                                case 'v_action': {
                                    return h(VTableUIAction, {
                                        props: {
                                            value: value || []
                                        }
                                    });
